            ...
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={styles.bottomBox}>
                    <View style={styles.grid}>
                        ...
                        <TouchableOpacity style={styles.menuButton} onPress={() => router.push('/cuidador/remedios')}>
                            <Ionicons name="medkit-outline" size={38} color="#321904" />
                            <Text style={styles.menuText}>Remédios</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.menuButton} onPress={() => router.push('/cuidador/relatorio')}>
                            <Ionicons name="heart-outline" size={38} color="#321904" />
                            <Text style={styles.menuText}>Relatório</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.menuButton} onPress={() => router.push('/cuidador/agenda')}>
                            <Ionicons name="calendar-outline" size={38} color="#321904" />
                            <Text style={styles.menuText}>Agenda</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.menuButton} onPress={() => router.push('/cuidador/bpm')}>
                            <Ionicons name="heart-circle" size={38} color="#321904" />
                            <Text style={styles.menuText}>Batimentos</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.menuButton} onPress={() => router.push('/cuidador/adicionarCuidador')}>
                            <Ionicons name="person" size={38} color="#321904" />
                            <Text style={styles.menuText}>Idosos</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </View>
